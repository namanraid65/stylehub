  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-0.5">Manage orders for your store products</p>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="relative max-w-sm">
            ...
            <Input placeholder="Order ID or customer name…" value={search} onChange={(e) => setSearch(e.target.value)} className="pl-9" />
          </div>
